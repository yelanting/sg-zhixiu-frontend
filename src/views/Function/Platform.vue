<template>
    ...
    >
        ...
        <div
            style="position:absolute;top:60px;left:20px;padding-top:20px;margin-bottom:50px;padding-bottom:50px;width:100%" v-if="!emptyList">
        ...
        <div style="position:absolute;top:60px;left:20px;padding-top:20px;margin-bottom:50px;padding-bottom:50px;width:100%" v-else>
          <p>暂无数据</p>
        </div>
        ...
        findPage: function (data) {
            ...
            this.$api.platform
                ...
                .then(res => {
                    ...
                    this.emptyList = this.platformCounts === 0
                })
